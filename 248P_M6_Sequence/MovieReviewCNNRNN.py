...
def build_model():
    ...
    #Conv1D and maxpool layers provide input to RNN layer using GRU with dropout to handle overfitting
...
def main():
    ...
    #Build model with 1DConvNet and RNN
    model = build_model()
    model.summary()
    #train and evaluate
    ...
    plot(history)
    """
    Rerun on correct number of epochs before testing
    """
    print("****Test results***")
